      ...
      <div className="mx-auto max-w-7xl">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-white/40">
            Discover original artwork, creative experiments and visual stories
            from Luqqss temmy.
          </p>
        </div>
        ...
        <div className="relative mt-8">
          ...
          <button
            ...
            onClick={() =>
              categoryRef.current?.scrollBy({ left: -320, behavior: "smooth" })
            }
        ...
        {loading ? (
          ...
          <div className="mt-10 columns-1 gap-5 sm:columns-2 lg:columns-3">
            {filteredArtworks.map((artwork) => (
              <article key={artwork.id} className="group mb-5 break-inside-avoid">
                <Link href={`/artwork/${(artwork as any).slug}`} className="block">
                  ...
                  <div className="flex items-start justify-between gap-4 px-1 pt-4">
                    ...
                    <span className="text-xs text-white/25">Luqqss temmy</span>
                  </div>
                </Link>
              </article>
            ))}
          ...
          <div className="mt-10 rounded-[24px] border border-white/[0.08] bg-white/[0.025] px-6 py-20 text-center backdrop-blur-xl">
            <Search size={22} strokeWidth={1.5} className="mx-auto text-white/20" />
